...
router.post('/create', authMiddleware, async (req, res) => {
  try {
    const { mode, opponentType, botLevel, isRanked, betAmount } = req.body;
    const result = await matchmakingService.createSession(req.userId, mode, opponentType, botLevel, isRanked, betAmount);
