...
const ITEMS_CATALOG = {
  characters: [
    ...
    { id: 'bocah_warnet', name: 'Bocah Warnet', price: 100, type: 'character' },
    { id: 'magang_domino', name: 'Magang Domino', price: 150, type: 'character' },
    { id: 'satpam_meja', name: 'Satpam Meja', price: 200, type: 'character' },
    { id: 'kapten_kartu', name: 'Kapten Kartu', price: 300, type: 'character' },
    { id: 'pawang_domino', name: 'Pawang Domino', price: 400, type: 'character' },
    { id: 'raja_domino', name: 'Raja Domino', price: 500, type: 'character' },
    { id: 'si_paling_gaple', name: 'Si Paling Gaple', price: 600, type: 'character' },
    { id: 'ratu_casino', name: 'Ratu Casino', price: 750, type: 'character' },
    { id: 'si_hoki', name: 'Si Hoki', price: 800, type: 'character' },
    { id: 'bandar_darat', name: 'Bandar Darat', price: 1000, type: 'character' },
    { id: 'hacker_gaple', name: 'Hacker Gaple', price: 1200, type: 'character' },
    { id: 'juragan_meja', name: 'Juragan Meja', price: 1500, type: 'character' },
    { id: 'eyang_hoki', name: 'Eyang Hoki', price: 1800, type: 'character' },
    { id: 'master_zen', name: 'Master Zen', price: 2200, type: 'character' },
    { id: 'sang_bluffer', name: 'Sang Bluffer', price: 2500, type: 'character' },
    { id: 'legenda_royale', name: 'Legenda Royale', price: 3000, type: 'character' }
  ],
  skins: [
