...
const ITEMS_CATALOG = {
  characters: [
    ...
    { id: 'bocah_warnet', name: 'Bocah Warnet', price: 100, skill: 'Bonus coin +3% tiap menang', type: 'character' },
    { id: 'magang_domino', name: 'Magang Domino', price: 150, skill: 'Bonus coin +5% tiap menang', type: 'character' },
    { id: 'satpam_meja', name: 'Satpam Meja', price: 200, skill: 'Bonus coin +6% tiap menang', type: 'character' },
    { id: 'kapten_kartu', name: 'Kapten Kartu', price: 300, skill: 'Bonus coin +10% tiap menang', type: 'character' },
    { id: 'pawang_domino', name: 'Pawang Domino', price: 400, skill: 'Bonus coin +8% tiap menang', type: 'character' },
    { id: 'raja_domino', name: 'Raja Domino', price: 500, skill: 'Bonus coin +15% tiap menang', type: 'character' },
    { id: 'si_paling_gaple', name: 'Si Paling Gaple', price: 600, skill: 'Bonus coin +12% tiap menang', type: 'character' },
    { id: 'ratu_casino', name: 'Ratu Casino', price: 750, skill: 'Bonus coin +15% tiap menang', type: 'character' },
    { id: 'si_hoki', name: 'Si Hoki', price: 800, skill: 'Lihat 1 kartu lawan per game (sekali)', type: 'character' },
    { id: 'bandar_darat', name: 'Bandar Darat', price: 1000, skill: 'Bonus coin +18% tiap menang', type: 'character' },
    { id: 'hacker_gaple', name: 'Hacker Gaple', price: 1200, skill: 'Bonus coin +20% tiap menang', type: 'character' },
    { id: 'juragan_meja', name: 'Juragan Meja', price: 1500, skill: 'Undo 1 langkah per game', type: 'character' },
    { id: 'eyang_hoki', name: 'Eyang Hoki', price: 1800, skill: 'Bonus coin +22% tiap menang', type: 'character' },
    { id: 'master_zen', name: 'Master Zen', price: 2200, skill: 'Bonus coin +25% tiap menang', type: 'character' },
    { id: 'sang_bluffer', name: 'Sang Bluffer', price: 2500, skill: 'Skip tanpa penalty 1x per game', type: 'character' },
    { id: 'legenda_royale', name: 'Legenda Royale', price: 3000, skill: 'Bonus coin +30% tiap menang', type: 'character' }
  ],
  skins: [
    { id: 'classic', name: 'Classic Ivory', price: 0, type: 'skin' },
    { id: 'candy_pop', name: 'Candy Pop', price: 250, type: 'skin' },
    { id: 'ocean_blue', name: 'Ocean Blue', price: 300, type: 'skin' },
    { id: 'sakura_blossom', name: 'Sakura Pink', price: 350, type: 'skin' },
    { id: 'ruby_red', name: 'Ruby Red', price: 400, type: 'skin' },
    { id: 'volcano', name: 'Volcano Ash', price: 450, type: 'skin' },
    { id: 'cyberpunk', name: 'Neon Cyberpunk', price: 500, type: 'skin' },
    { id: 'marble_white', name: 'Carrara Marble', price: 550, type: 'skin' },
    { id: 'midnight', name: 'Midnight Black', price: 600, type: 'skin' },
    { id: 'carbon_fiber', name: 'Carbon Fiber', price: 800, type: 'skin' },
    { id: 'emerald', name: 'Emerald Felt', price: 900, type: 'skin' },
    { id: 'rainbow_unicorn', name: 'Rainbow Unicorn', price: 1000, type: 'skin' },
    { id: 'royal_gold', name: 'Royal Gold', price: 1200, type: 'skin' },
    { id: 'golden_luxury', name: 'Golden Luxury', price: 1500, type: 'skin' }
  ],
  powerups: [
